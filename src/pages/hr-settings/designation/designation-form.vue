  ...
  <b-form class="needs-validation" novalidate="">
    <b-row class="alignment">
      <b-col cols="12" class="bg-light mt-3">
        <h3 class="mt-3 text-black">নতুন পদবী সংযোজন</h3>
      </b-col>
    </b-row>
    ...
    <b-row class="mx-2 p-1 rounded border bg-white alignment">
      ...
      <b-col cols="12" md="6" class="mt-3">
        <b-form-group class="text-black" label="পদবী  (বাংলা)*">
          <b-form-input
            :disabled="mode == 'view'"
            v-model="form.name_bn"
            placeholder="পদবী  বাংলায় লিখুন"
            required
          ></b-form-input>
        </b-form-group>
      ...
      <b-col cols="12" md="6" class="mt-3">
        <b-form-group class="text-black" label="পদবী  (ইংরেজী)*">
          <b-form-input
            :disabled="mode == 'view'"
            v-model="form.name"
            placeholder="পদবী  ইংরেজীতে লিখুন"
            required
          ></b-form-input>
        </b-form-group>
      ...
      <b-col cols="12" md="6" class="mt-3">
        <b-form-group class="text-black" label="পদবী  কোড ">
          <b-form-input
            :disabled="mode == 'view'"
            v-model="form.code"
            placeholder="পদবী  কোড  লিখুন"
            required
          ></b-form-input>
        </b-form-group>
    ...
    createDesignation() {
      if (
        ...
        if (
          ...
          this.$store
            .dispatch("designation/createDesignation", this.form)
            .then((res) => {
              if (res.status === 200) {
    ...
    updateDesignation() {
      if (
        ...
        if (
          ...
          this.$store
            .dispatch("designation/updateDesignation", this.form)
            .then((res) => {
              if (res.status == 200) {
                this.$router.push(`/designations`);
              }
