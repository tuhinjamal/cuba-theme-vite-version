  ...
  <b-form class="needs-validation" novalidate="">
    <b-row class="alignment">
      <b-col cols="12" class="bg-light mt-3">
        <h3 class="mt-3 text-black">নতুন সেকশন সংযোজন</h3>
      </b-col>
    </b-row>
    ...
    <b-row class="mx-2 p-1 rounded border bg-white alignment">
      ...
      <b-col cols="12" md="6" class="mt-3">
        <b-form-group class="text-black" label="ব্রাঞ্চ ">
          <multiselect
      ...
      <b-col cols="12" md="6" class="mt-3">
        <b-form-group class="text-black" label="সেকশনের নাম (বাংলা)">
          <b-form-input
            :disabled="mode == 'view'"
            v-model="form.name_bn"
            placeholder="সেকশনের    পুরো নাম বাংলায় লিখুন"
            required
          ></b-form-input>
        </b-form-group>
      ...
      <b-col cols="12" md="6" class="mt-3">
        <b-form-group class="text-black" label="সেকশনের নাম (ইংরেজী)">
          <b-form-input
            :disabled="mode == 'view'"
            v-model="form.name"
            placeholder="সেকশনের পুরো নাম ইংরেজীতে লিখুন"
            required
          ></b-form-input>
        </b-form-group>
      ...
      <b-col cols="12" md="6" class="mt-3">
        <b-form-group class="text-black" label="সেকশনের   কোড ">
          <b-form-input
            :disabled="mode == 'view'"
            v-model="form.code"
            placeholder="ব্রাঞ্চের  কোড  লিখুন"
            required
          ></b-form-input>
        </b-form-group>
...
export default {
  ...
  methods: {
    createSection() {
      if (
        ...
        if (
          ...
          this.selectedWingError = "ব্রাঞ্চ সিলেক্ট করুন";
        } else {
        ...
        if (
          ...
          this.form.branchId = this.selectedWing.id;
          this.$store
            .dispatch("section/createSection", this.form)
            .then((res) => {
              if (res.status === 200) {
    ...
    updateSection() {
      if (
        ...
        if (
          ...
          this.form.branchId = this.selectedWing.id;
          this.$store
            .dispatch("section/updateSection", this.form)
            .then((res) => {
              if (res.status === 200) {
                this.$router.push(`/sections`);
              }
    ...
    async getWings() {
      let wingRes = await this.$store.dispatch("branch/getBranch");
      this.wings = await wingRes.data;

      this.selectedWing = await wingRes.data.find(
        (e) => e.id === this.form.branchId
      );
    },
  },
};
